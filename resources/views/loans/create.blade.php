                            ...
                            <div class="card-body">
                                ...
                                <form class="form" action="{{ route('loans.store') }}" method="POST">
                                    ...
                                    <div class="form-group m-t-40 row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="text" value="{{{ isset(Auth::user()->name) ? ucfirst(Auth::user()->name) : '' }}}" name="name" id="example-text-input">
                                        </div>
                                    </div>
                                      <div class="form-group m-t-40 row">
                                    ...
                                    <div class="form-group m-t-40 row">
                                      ...
                                      <div class="form-group m-t-40 row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="text" value="{{ old('amount_saved') }}" name="amount_saved" id="example-text-input">
                                        </div>
                                    </div>
                                    <div class="form-group m-t-40 row">
                                     ...
                                     <div class="form-group m-t-40 row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="text" value="{{ old('amount_outstanding') }}" name="amount_outstanding" id="example-text-input">
                                        </div>
                                    </div>
                                      <div class="form-group m-t-40 row">
                                        <label for="example-text-input" class="col-2 col-form-label">Amount of Advance</label>
                                        <div class="col-10">
                                            <input class="form-control" type="text" value="{{ old('amount_of_advance') }}" name="amount_of_advance" id="example-text-input">
                                        </div>
                                    </div>
                                        <div class="form-group m-t-40 row">
                                        <label for="example-text-input" class="col-2 col-form-label">Period Of Payment</label>
                                        <div class="col-10">
                                            <input class="form-control" type="text" value="{{ old('period_of_payment') }}" name="period_of_payment" id="example-text-input">
                                        </div>
                                    </div>
                                    <div class="form-group m-t-40 row">
                                        <label for="example-text-input" class="col-2 col-form-label">Purpose of Loan</label>
                                        <div class="col-10"> 
                                            <textarea class="form-control" type="text" name="purpose_of_loan" rows="3"  id="example-text-input">{{ old('purpose_of_loan') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group m-t-40 row">
                                     ...
                                     <div class="form-group m-t-40 row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="text" value="{{ old('e_account') }}" name="e_account" id="example-text-input">
                                        </div>
                                    </div>
                                     <div class="form-group m-t-40 row">
