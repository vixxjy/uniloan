                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle"> Edit more products </h6>
                                @if($errors->any())
                                ...
                                <form class="form" action="{{ route('products.update', $product->id) }}" method="POST">
                                    ...
                                    <div class="form-group m-t-40 row">
                                      ...
                                      <div class="form-group m-t-40 row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="text" value="{{ $product->description }}" name="description" id="example-text-input">
                                        </div>
                                    </div>
                                      <div class="form-group m-t-40 row">
                                        <label for="example-text-input" class="col-2 col-form-label">Price (#)</label>
                                        <div class="col-10">
                                            <input class="form-control" type="text" value="{{ $product->price }}" name="price" id="example-text-input">
                                        </div>
                                    </div>
