                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Edit     Users Registration Form</h4>
                                <h6 class="card-subtitle"> Edit users </h6>
                                @if($errors->any())
                                ...
                                <form class="form" action="{{ route('users.update', $user->id) }}" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="email" value="{{ $user->email }}" name="email" id="example-email-input">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="password" name="password" value="{{ $user->password }}" id="example-password-input">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="example-password-input" class="col-2 col-form-label">Confirm Password</label>
                                        <div class="col-10">
                                            <input class="form-control" type="password" name="password_confirmation" value="{{ $user->password }}" id="example-password-input">
                                        </div>
                                    </div>
